...
class MultiLayerPerceptron(object):
    ...
    def forward_propagation(self, X):
        ...
        h3 = z2 @ W3 + b3
        z3 = tanh(h3 + h1)          # ← skip connection: h1을 더함

        h4 = z3 @ W4 + b4
        y_hat = sigmoid(h4)
        y_hat = y_hat.reshape(-1)   # (N,1) → (N,)
    ...
    def back_propagation(self, cache, X, y, L2_norm=0.0):
        ...
        dh3 = dz3 * (1 - z3 ** 2)                 # tanh 도함수 = 1 - tanh²
        ...
        dh1 = dz1 * relu_grad(h1) + dh3           # ← skip 때문에 dh3를 더함
    ...
    def predict(self, X):
        ...
        return predictions
# 순전파로 확률 뽑고, 0.5이상이면 1, 아니면 0으로 계산. 
